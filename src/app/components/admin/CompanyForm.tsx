    ...
    >
      ...
      >
        ...
        <div className="sticky top-0 bg-white/90 backdrop-blur-lg border-b border-gray-100 p-6 flex items-center justify-between z-10">
          <div>
            <h2 className="text-2xl font-bold text-[#142361]">
          ...
          >
            <X className="w-6 h-6 text-[#142361]" />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-8">
          ...
          {isJobOnly ? (
            <div className="space-y-6">
               <div className="flex items-center gap-2 text-[#e0653b] font-bold text-sm uppercase tracking-widest">
                <Users className="w-4 h-4" />
                Select Existing Company
              </div>
              <div className="space-y-1">
                <label className="text-sm font-bold text-[#142361]">Company Name</label>
                <select
                  value={selectedCompanyId}
                  onChange={(e) => setSelectedCompanyId(e.target.value)}
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-[#e0653b] outline-none appearance-none cursor-pointer bg-white transition-all"
                  required
                >
            ...
            <>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-1">
                    <label className="text-sm font-bold text-[#142361]">Client Name / Company</label>
                    <input
                      type="text"
                      value={companyName}
                      onChange={(e) => setCompanyName(e.target.value)}
                      className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-[#e0653b] outline-none transition-all"
                      placeholder="e.g. Google India"
                      required
                    />
                  </div>
                  <div className="space-y-1">
                    <label className="text-sm font-bold text-[#142361]">Official Website</label>
                    <input
                      type="url"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-1">
                    <label className="text-sm font-bold text-[#142361]">Engagement Stage</label>
                    <select
                      value={stage}
                  ...
                  <div className="space-y-1">
                    <label className="text-sm font-bold text-[#142361]">Priority Status</label>
                    <select
                      value={priority}
              ...
              <div className="space-y-6 pt-6 border-t border-gray-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="space-y-1">
                    <label className="text-sm font-bold text-[#142361]">Full Name</label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-1">
                    <label className="text-sm font-bold text-[#142361]">Email Address</label>
                    <input
                      type="email"
                      value={primaryEmail}
                  ...
                  <div className="space-y-1">
                    <label className="text-sm font-bold text-[#142361]">Phone Number</label>
                    <input
                      type="tel"
                      value={primaryPhone}
          ...
          <div className="space-y-6 pt-6 border-t border-gray-100 bg-gray-50/50 p-6 rounded-3xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="space-y-1">
                <label className="text-sm font-bold text-[#142361]">Action Date</label>
                <div className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-100 text-gray-500 font-bold flex items-center gap-2">
                   <Clock className="w-4 h-4 text-[#e0653b]" />
                   {today}
                </div>
              </div>
              <div className="md:col-span-2 space-y-1">
                <label className="text-sm font-bold text-[#142361]">Action Item Description</label>
                <input
                  type="text"
                  value={actionItem}
          ...
          <div className="space-y-6 pt-6 border-t border-gray-100">
            <div className="flex items-center justify-between">
              ...
              <button
                type="button"
                onClick={addPosition}
                className="flex items-center gap-2 px-4 py-2 bg-[#142361] text-white rounded-xl text-sm font-bold hover:opacity-90 shadow-md transition-all"
              >
            ...
            <div className="grid gap-6">
              {positions.map((pos, idx) => (
                <div key={idx} className="relative p-6 bg-white border-2 border-gray-100 rounded-3xl hover:border-[#e0653b]/30 transition-all">
                  <button
                    type="button"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 bg-gray-50 rounded-lg border-none focus:ring-2 focus:ring-[#e0653b]"
                    ...
                    <div className="space-y-1">
                      ...
                      <select
                        ...
                        className="w-full px-3 py-2 bg-gray-50 rounded-lg border-none focus:ring-2 focus:ring-[#e0653b] appearance-none cursor-pointer"
                      >
                  ...
                  <div className="space-y-1">
                    ...
                    <textarea
                      ...
                      className="w-full px-3 py-2 bg-gray-50 rounded-lg border-none focus:ring-2 focus:ring-[#e0653b] resize-none"
                      rows={2}
          ...
          {!company && !isJobOnly && (
            <div className="space-y-6 pt-6 border-t border-gray-100">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-1">
                  <label className="text-sm font-bold text-[#142361]">Activity Detail</label>
                  <input
                    type="text"
                    value={activityText}
                ...
                <div className="space-y-1">
                  <label className="text-sm font-bold text-[#142361]">Action Owner</label>
                  <input
                    type="text"
                    value={actionOwner}
          ...
          <div className="flex items-center gap-4 pt-8 sticky bottom-0 bg-white py-4 border-t border-gray-100">
            <button
              type="submit"
              className="flex-1 py-4 bg-[#e0653b] text-white rounded-2xl font-bold text-lg shadow-xl shadow-[#e0653b]/20 hover:opacity-90 transition-all"
            >
            ...
            <button
              type="button"
              onClick={onClose}
              className="px-8 py-4 border-2 border-gray-200 rounded-2xl font-bold text-[#142361] hover:bg-gray-50 transition-all"
            >
              Cancel
            </button>
          </div>
