    ...
    return (
      <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 py-12 text-center">
          <h2 className="text-2xl mb-4" style={{ color: '#142361' }}>
            Company Not Found
          </h2>
          <button
          ...
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-6 mb-8">
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-4">
                <h1 className="text-4xl font-bold tracking-tight" style={{ color: '#142361' }}>
          ...
          <div className="lg:col-span-2 space-y-8">
            <section className="bg-white rounded-3xl p-8 border border-gray-200/50 shadow-lg">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold flex items-center gap-3" style={{ color: '#142361' }}>
                  <Briefcase className="w-7 h-7 text-[#e0653b]" />
                ...
                <div className="grid grid-cols-1 gap-4">
                  {company.positions.map((position) => (
                    <div key={position.id} className="p-5 bg-gray-50 rounded-2xl border border-gray-100">
                      <h3 className="text-lg font-bold mb-2" style={{ color: '#e0653b' }}>{position.role}</h3>
            ...
            <section className="bg-white rounded-3xl p-8 border border-gray-200/50 shadow-lg">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold flex items-center gap-3" style={{ color: '#142361' }}>
                  <Calendar className="w-7 h-7 text-[#e0653b]" />
                  Engagement Timeline
                </h2>
                <button
                  ...
                  {company.activities
                    ...
                    .map((activity) => (
                      <div key={activity.id} className="relative pl-8 border-l-2 border-gray-100 pb-2">
                        <div className="absolute -left-[9px] top-0 w-4 h-4 rounded-full bg-white border-2 border-[#e0653b]" />
                        <div className="p-5 bg-gray-50 rounded-2xl border border-gray-100 hover:border-[#e0653b20] transition-colors">
                          <div className="flex flex-wrap items-center gap-3 mb-3 text-xs font-bold text-gray-500 uppercase tracking-wider">
                            <span className="text-[#142361]">{new Date(activity.date).toDateString()}</span>
                            <span>•</span>
