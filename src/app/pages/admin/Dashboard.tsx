        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border border-[#142361] bg-white transition-all hover:bg-gray-50 text-[#142361] font-bold shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            >
              <div className="backdrop-blur-lg bg-white/80 p-6 rounded-3xl border border-gray-200/50 shadow-lg grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="block text-xs font-bold uppercase tracking-widest text-[#142361] flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-[#e0653b]" />
                    Business Stage
                  </label>
                  <select
                    value={stageFilter}
                    onChange={(e) => setStageFilter(e.target.value)}
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#e0653b] bg-white text-[#142361] font-medium transition-all shadow-sm cursor-pointer appearance-none"
                  >
                ...
                <div className="space-y-2">
                  <label className="block text-xs font-bold uppercase tracking-widest text-[#142361] flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-[#142361]" />
                    Priority Status
                  </label>
                  <select
