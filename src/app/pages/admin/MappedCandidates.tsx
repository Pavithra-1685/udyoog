      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="flex bg-gray-100 border border-gray-200 p-1 rounded-2xl self-start sm:self-auto">
            <button
              ...
              className={`px-4 py-2 text-xs font-black uppercase rounded-xl transition-all ${
                viewMode === 'individual'
                  ? 'bg-white text-[#142361] shadow-sm'
        ...
        <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm mb-8 grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
          <div className="relative">
            <input
              type="text"
              placeholder="Search candidate, SIF No, job..."
                      ...
                      <tr key={item.id} className="hover:bg-gray-50/40 transition-colors group">
                        <td className="p-5">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <div className="font-extrabold text-[#142361] group-hover:text-[#e0653b] transition-all cursor-pointer" onClick={() => navigate(`/faculty/student/${item.student?.sif_no || item.student?.registration_no}`)}>
                  ...
                  >
                    <div>
                      <div className="flex items-start justify-between mb-4">
                        <div>
                          <span className="text-[10px] px-2.5 py-0.5 bg-[#e0653b]/5 text-[#e0653b] border border-[#e0653b]/20 rounded font-black uppercase tracking-wider">
                            {job.companies?.company_name || 'Company'}
                          </span>
                          <h4 className="text-lg font-black text-[#142361] mt-1.5">{job.role}</h4>
                        </div>
                        <button
                          onClick={() => setSelectedJobForModal(job)}
                          className="p-2.5 rounded-2xl bg-gray-50 border border-gray-100 hover:bg-[#e0653b]/10 hover:border-[#e0653b]/20 text-[#142361] hover:text-[#e0653b] transition-all"
                    ...
                    <div className="mt-6 pt-4 border-t border-gray-100 flex items-center justify-between">
                      ...
                      <button
                        onClick={() => setSelectedJobForModal(job)}
                        className="text-xs font-bold text-[#e0653b] hover:text-[#142361] flex items-center gap-1 transition-colors"
                      >
            ...
            >
              ...
              <div className="p-6 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
                <div>
                  ...
                  <h3 className="text-xl font-black text-[#142361] mt-1.5 flex items-center gap-2">
                      ...
                      {jobMappings.map((item) => (
                        ...
                        >
                          ...
                          <div className="flex items-center gap-4">
                            <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center font-bold text-[#142361] border border-gray-100 shadow-sm">
                              {item.student?.full_name?.charAt(0)}
                            </div>
                            <div>
                              <div className="font-extrabold text-[#142361] hover:text-[#e0653b] cursor-pointer transition-colors" onClick={() => {
                              ...
                              <div className="text-xs text-gray-500 font-mono flex flex-wrap items-center gap-2 mt-0.5">
                                <span className="bg-white px-2 py-0.5 rounded border border-gray-100 font-black">
                                  SIF NO: {item.student?.sif_no || item.student?.registration_no}
                                </span>
                                <span>•</span>
              ...
              <div className="p-6 border-t border-gray-100 flex justify-end bg-gray-50/50">
                <button
                  onClick={() => setSelectedJobForModal(null)}
                  className="px-6 py-2.5 bg-[#142361] text-white rounded-xl font-bold text-sm hover:opacity-90 transition-all shadow-md"
                >
                  Close Pipeline
                </button>
              </div>
