...
export default function InterviewPrep() {
  ...
  const getSkillBadgeColor = (level: string) => {
    switch (level) {
      ...
      case 'Intermediate': return 'bg-blue-50 text-blue-700 border-blue-200/50';
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
        <div className="absolute top-[10%] left-[-10%] w-[35rem] h-[35rem] rounded-full bg-[#142361]/5 blur-[120px]" />
        <div className="absolute bottom-[10%] right-[-10%] w-[30rem] h-[30rem] rounded-full bg-[#e0653b]/5 blur-[100px]" />
      </div>
        ...
        <header className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6 shrink-0">
          <div className="flex items-center gap-4">
            <button 
              ...
              className="p-2.5 bg-white border border-gray-100 hover:bg-gray-50 rounded-2xl shadow-sm transition-all hover:scale-105 active:scale-95 text-gray-500 hover:text-[#142361]"
            >
              <ArrowLeft className="w-5 h-5" />
            </button>
            <div>
              <h1 className="text-2xl font-black text-[#142361] tracking-tight flex items-center gap-2">
                <BrainCircuit className="w-6 h-6 text-[#e0653b] animate-pulse" />
                AI Interview Prep
              </h1>
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2 px-4 py-2.5 bg-white border border-gray-100 rounded-2xl shadow-sm">
              ...
              <span className="text-xs font-black text-[#142361] uppercase tracking-wider">Coach Active</span>
            </div>
        ...
        <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch overflow-hidden min-h-0">
          ...
          <aside className="lg:col-span-4 flex flex-col gap-6 overflow-y-auto pr-1">
            ...
            <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-6 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl from-[#142361]/5 to-transparent rounded-bl-full pointer-events-none" />
              ...
              {profileAnalysisLoading ? (
                <div className="py-8 flex flex-col items-center justify-center text-center">
                  <Loader2 className="w-8 h-8 text-[#142361] animate-spin mb-3" />
                ...
                <div className="space-y-5">
                  ...
                  <div className="flex items-center gap-3 pb-4 border-b border-gray-50">
                    <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-[#142361] to-[#1d3080] flex items-center justify-center text-white text-lg font-black shadow-md shadow-[#142361]/10">
                      {profile.full_name?.charAt(0) || 'C'}
                    </div>
                    <div>
                      <h4 className="font-extrabold text-[#142361] text-base leading-tight">{profile.full_name}</h4>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="p-3 bg-gray-50/70 border border-gray-100 rounded-2xl text-center">
                      ...
                      <span className="text-base font-extrabold text-[#142361] mt-0.5 block">{profile.cgpa ? parseFloat(profile.cgpa).toFixed(2) : '0.00'}</span>
                    </div>
                    <div className="p-3 bg-gray-50/70 border border-gray-100 rounded-2xl text-center">
                      <span className="text-[10px] font-black text-gray-400 uppercase tracking-wider block">Batch</span>
                      <span className="text-base font-extrabold text-[#142361] mt-0.5 block">{profile.batch || 'N/A'}</span>
                    </div>
                  </div>
                      ...
                      <div className="space-y-2">
                        {profile.projects.slice(0, 2).map((proj: Project, idx: number) => (
                          <div key={idx} className="p-3 bg-gray-50/60 border border-gray-100 rounded-2xl text-left hover:bg-gray-50 transition-colors">
                            <span className="font-extrabold text-xs text-[#142361] flex items-center gap-1.5">
                              <BookOpen className="w-3.5 h-3.5 text-[#e0653b]" />
                              {proj.name}
                            </span>
                ...
                <div className="py-4 text-center">
                  ...
                  <button 
                    ...
                    className="mt-3 text-xs font-bold text-[#e0653b] hover:underline"
                  >
                    Go to Profile Form
                  </button>
                </div>
                    ...
                    <div key={index} className="flex items-start gap-4 group">
                      <div className="flex flex-col items-center">
                        <div className={`w-8 h-8 rounded-full flex items-center justify-center border text-xs font-bold transition-all duration-300 relative
                          ${isCompleted 
                            ? 'bg-[#142361] border-[#142361] text-white' 
                            : isActive 
                              ? 'bg-orange-50 border-[#e0653b] text-[#e0653b] shadow-md shadow-orange-100 ring-4 ring-orange-50 animate-pulse'
                        ...
                        {index < 4 && (
                          <div className={`w-0.5 h-10 mt-2 transition-all duration-300
                            ${isCompleted ? 'bg-[#142361]' : 'bg-gray-100'}
                          `} />
                        )}
                      </div>
                      <div className="pt-0.5">
                        <h4 className={`text-xs font-black uppercase tracking-wider leading-none transition-colors
                          ${isCompleted ? 'text-gray-500' : isActive ? 'text-[#142361]' : 'text-gray-400'}
                        `}>
                          {item.label}
                        </h4>
          ...
          <main className="lg:col-span-8 flex flex-col min-h-[500px] bg-white rounded-3xl border border-gray-100 shadow-xl overflow-hidden relative">
            ...
            <div className="px-6 py-4 border-b border-gray-100 bg-gray-50/50 flex items-center justify-between shrink-0">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-xl bg-orange-50 flex items-center justify-center text-[#e0653b]">
                  <Bot className="w-5 h-5" />
                </div>
                <div>
                  <h4 className="font-extrabold text-sm text-[#142361]">AI Coach Evaluator</h4>
              ...
              {!interviewComplete && messages.length > 0 && (
                <div className="px-3.5 py-1.5 bg-[#142361] text-white text-[11px] font-black rounded-xl uppercase tracking-widest shadow-inner shadow-[#142361]/10">
              ...
              <AnimatePresence mode="popLayout">
                    ...
                    >
                      <div className={`flex gap-3 max-w-[85%] ${isCoach ? '' : 'flex-row-reverse'}`}>
                        <div className={`w-9 h-9 rounded-2xl flex items-center justify-center shrink-0 shadow-sm border transition-all
                          ${isCoach 
                            ? 'bg-[#142361] text-white border-[#142361]' 
                            : 'bg-[#e0653b] text-white border-[#e0653b]/20 shadow-orange-100'
                          }
                        `}>
                        ...
                        <div className={`p-4 rounded-3xl text-sm leading-relaxed shadow-sm transition-all
                          ${isCoach 
                            ? 'bg-gray-50/80 text-[#142361] border border-gray-100 rounded-tl-none font-medium' 
                            : 'bg-[#142361] text-white rounded-tr-none shadow-md shadow-slate-100'
                          }
                        `}>
                          {isCoach ? (
                ...
                {isTyping && (
                  ...
                  >
                    <div className="flex gap-3">
                      <div className="w-9 h-9 rounded-2xl bg-[#142361] text-white flex items-center justify-center border border-[#142361]">
                        <Loader2 className="w-5 h-5 animate-spin" />
                      </div>
                      <div className="bg-gray-50/80 p-4 rounded-3xl rounded-tl-none border border-gray-100 flex items-center gap-1.5">
                        <span className="w-1.5 h-1.5 bg-[#e0653b] rounded-full animate-bounce" />
                        <span className="w-1.5 h-1.5 bg-[#e0653b] rounded-full animate-bounce [animation-delay:0.2s]" />
                        <span className="w-1.5 h-1.5 bg-[#e0653b] rounded-full animate-bounce [animation-delay:0.4s]" />
                ...
                {interviewComplete && !isTyping && (
                  ...
                  >
                    ...
                    <div className="bg-gradient-to-r from-[#142361] to-[#1d3080] rounded-3xl p-6 text-white text-center relative overflow-hidden shadow-xl shadow-[#142361]/10">
                      <div className="absolute inset-0 pointer-events-none opacity-20 bg-[radial-gradient(circle_at_30%_30%,#e0653b_0%,transparent_60%)]" />
                      <Trophy className="w-12 h-12 text-[#e0653b] mx-auto mb-3 animate-bounce" />
                    ...
                    <div className="bg-gray-50 border border-gray-100 rounded-3xl p-6 space-y-6 shadow-inner">
                      <div className="flex items-center justify-between border-b border-gray-200/50 pb-4">
                        ...
                        <div className="flex gap-2">
                          ...
                          <button 
                            ...
                            className="flex items-center gap-1.5 px-3 py-1.5 bg-[#e0653b] text-white hover:bg-[#c95a34] rounded-xl text-xs font-bold transition-all shadow-sm"
                          >
                      ...
                      <div className="prose prose-sm max-w-none text-[#142361] space-y-4">
                        {messages[messages.length - 1]?.content
                          ...
                          .map((chunk, chunkIdx) => {
                            ...
                            let sectionIcon = <Award className="w-5 h-5 text-[#e0653b]" />;
                            if (title.toLowerCase().includes('strength')) {
                              ...
                              sectionIcon = <AlertCircle className="w-5 h-5 text-amber-500" />;
                            } else if (title.toLowerCase().includes('action')) {
                              sectionIcon = <Layers className="w-5 h-5 text-blue-500" />;
                            }
                            ...
                            return (
                              ...
                              >
                                <h4 className="font-extrabold text-sm text-[#142361] flex items-center gap-2 border-b border-gray-50 pb-2 uppercase tracking-wide">
                                  {sectionIcon}
                                  {title}
                                </h4>
                    ...
                    <div className="flex gap-4 pb-4">
                      <button 
                        onClick={handleRestart}
                        className="flex-1 py-4 bg-[#142361] text-white hover:bg-[#1d3080] rounded-2xl font-bold transition-all text-center flex items-center justify-center gap-2 shadow-lg shadow-[#142361]/10"
                      >
              ...
              <form onSubmit={handleSend} className="p-4 border-t border-gray-100 bg-gray-50/50 shrink-0">
                <div className="relative flex items-center">
                  <input
                    ...
                    className="w-full pl-6 pr-14 py-4 rounded-2xl border border-gray-200 focus:ring-2 focus:ring-[#142361] focus:border-transparent outline-none transition-all shadow-inner bg-white text-sm text-[#142361]"
                  />
                  <button
                    type="submit"
                    disabled={isLoading || !input.trim() || profileAnalysisLoading}
                    className="absolute right-2.5 p-3 bg-[#e0653b] text-white rounded-xl hover:bg-[#c95a34] transition-all disabled:opacity-50 disabled:grayscale shadow-lg shadow-[#e0653b]/20 hover:scale-105 active:scale-95"
                  >
                    {isLoading ? (
                      <Loader2 className="w-5 h-5 animate-spin" />
                    ) : (
                ...
                <p className="text-[10px] text-gray-400 font-bold text-center mt-2 flex items-center justify-center gap-1">
                  <Sparkles className="w-3.5 h-3.5 text-[#e0653b]" />
