...
export default function Preview() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-[var(--gold-gradient)] text-white py-2 px-4 flex items-center justify-center gap-4 text-xs font-bold uppercase tracking-[0.2em] sticky top-0 z-[60]">
      ...
      <Navigation userEmail="preview@careerpathway.app" />
        ...
        {activeTab === 'dashboard' ? (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              >
                ...
                <h2 className="text-2xl font-bold mb-1" style={{ color: '#111111' }}>{MOCK_PROFILE.full_name}</h2>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="h-2 bg-white/10 rounded-full overflow-hidden">
                      <div className="h-full bg-[var(--gold-gradient)] w-[85%]" />
                    </div>
                  </div>
          ...
          <div className="max-w-4xl mx-auto">
            <header className="mb-8 text-center">
              <h1 className="text-4xl font-bold mb-2" style={{ color: '#111111' }}>Edit Profile</h1>
