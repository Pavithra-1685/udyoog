    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <header className="mb-8">
          <h1 className="text-3xl font-bold text-[#111111]">Student Performance Analytics</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          <section className="lg:col-span-2 bg-white p-8 rounded-3xl border border-gray-100 shadow-sm">
            <h2 className="text-xl font-bold text-[#111111] mb-8 flex items-center gap-2">
              <PieChart className="w-5 h-5 text-[var(--gold-medium)]" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div className="relative w-64 h-64 mx-auto">
                <svg className="w-full h-full" viewBox="0 0 100 100">
                  ...
                  <motion.circle 
                    cx="50" cy="50" r="40" fill="transparent" stroke="var(--gold-medium)" strokeWidth="12"
                    ...
                    strokeLinecap="round"
                  />
                  <text x="50" y="50" textAnchor="middle" dy="0.3em" className="text-2xl font-black fill-[#111111]">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  <div className="w-4 h-4 rounded-full bg-[var(--gold-gradient)]"></div>
                  <div className="flex-1">
                    <div className="text-sm font-bold text-[#111111]">Skilled & Validated</div>
                    <div className="text-xs text-gray-400">At least one verified skill</div>
                  </div>
                  <div className="font-bold text-[#111111]">{skilledStudents.length}</div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-4 h-4 rounded-full bg-gray-200"></div>
                  <div className="flex-1">
                    <div className="text-sm font-bold text-[#111111]">Draft Portfolios</div>
          ...
          <section className="bg-[#111111] p-8 rounded-3xl text-white shadow-xl shadow-[#111111]/20">
            <h2 className="text-xl font-bold mb-6 flex items-center gap-2">
              <Target className="w-5 h-5 text-[var(--gold-medium)]" />
              Key Metrics
            </h2>
              ...
              skilledStudents.map((student) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center font-bold text-[#111111] shadow-sm">
                  ...
                  <ChevronRight className="w-4 h-4 text-gray-300 group-hover:text-[var(--gold-medium)] transition-all" />
                </div>
              ))
            ) : (
