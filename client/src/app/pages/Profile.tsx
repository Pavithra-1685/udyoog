    ...
    try {
      ...
      if (user) {
        ...
        if (profile) {
          ...
          setRegNo(profile.sif_no || profile.registration_no || '');
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { error: profileError } = await supabase
        ...
        .update({ 
          full_name: fullName,
          sif_no: role === 'faculty' ? regNo : undefined,
        })
        .eq('user_id', user.id);
            ...
            {role === 'student' ? (
              ...
              <form onSubmit={handleSave} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-medium mb-2 flex items-center gap-2" style={{ color: '#111111' }}>
                ...
                <div className="pt-4">
                  <button
                    type="submit"
                    disabled={isSaving}
                    className="flex items-center gap-2 px-8 py-3.5 rounded-xl text-white font-bold transition-all hover:opacity-90 disabled:opacity-50 shadow-lg shadow-[var(--gold-gradient)]/20"
            ...
            <form onSubmit={handleChangePassword} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-12 py-3 rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[var(--gold-medium)] bg-white/50"
                      required
                      placeholder="••••••••"
                    />
                    <button
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[var(--gold-medium)] bg-white/50"
                      required
                      minLength={8}
                      placeholder="••••••••"
                    />
              ...
              <div className="pt-2">
                <button
                  ...
                  className="flex items-center gap-2 px-8 py-3.5 rounded-xl text-white font-bold transition-all hover:opacity-90 disabled:opacity-50 shadow-lg shadow-[#111111]/20"
