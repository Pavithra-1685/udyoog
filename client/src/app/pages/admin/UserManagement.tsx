    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <header className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h1 className="text-3xl font-black text-[#111111]">Candidates & Users Registry</h1>
        ...
        <div className="grid grid-cols-1 gap-8 mb-8">
          <section className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
            <h2 className="text-xl font-bold text-[#111111] mb-4 flex items-center gap-2">
              <Search className="w-5 h-5 text-[var(--gold-medium)]" />
            ...
            <div className="relative">
              <input
                ...
                className="w-full pl-12 pr-4 py-4 rounded-2xl border border-gray-200 focus:ring-2 focus:ring-[var(--gold-medium)] focus:border-transparent outline-none transition-all text-sm font-medium"
                value={searchQuery}
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    <div className={`w-12 h-12 bg-white rounded-xl flex items-center justify-center font-bold border border-gray-100 shadow-sm ${
                      activeTab === 'faculty' ? 'text-[var(--gold-medium)]' : 'text-[#111111]'
                    }`}>
                      {userItem.full_name?.charAt(0)}
                    </div>
                    <div>
                      <div className="font-bold text-[#111111] group-hover:text-[var(--gold-medium)] transition-colors">
                        {userItem.full_name}
                      </div>
                      <div className="text-xs text-gray-500 font-mono flex flex-wrap items-center gap-2">
                        <span className="bg-white px-2 py-0.5 rounded border border-gray-100 font-black">
                          {activeTab === 'student' ? 'ROLL NO:' : 'EMP CODE:'} {userItem.sif_no || userItem.registration_no || 'N/A'}
                        </span>
                        <span>•</span>
                  ...
                  <div className="flex items-center justify-between sm:justify-end gap-6 border-t sm:border-t-0 pt-3 sm:pt-0 border-gray-100">
                    {activeTab === 'student' && (
                      <div className="text-left sm:text-right">
                        <div className="text-sm font-bold text-[#111111]">{userItem.cgpa || '0.0'} CGPA</div>
                    ...
                    {activeTab === 'faculty' && (
                      <div className="text-left sm:text-right">
                        <span className="text-[10px] px-2.5 py-0.5 bg-[#f4f1e6] text-[var(--gold-medium)] border border-[var(--gold-medium)]/40 rounded font-black uppercase tracking-wider">
                          Faculty
                        </span>
                      </div>
                    )}
        ...
        <AnimatePresence>
          <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
            ...
            <motion.div
              ...
              className="relative w-full max-w-md bg-white rounded-3xl shadow-2xl border border-gray-200/80 overflow-hidden flex flex-col z-[10000] my-auto max-h-[90vh]"
              ...
              <form onSubmit={handleFormSubmit} className="p-6 space-y-4 overflow-y-auto flex-1 custom-scrollbar">
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-200 text-sm font-medium focus:ring-2 focus:ring-[var(--gold-medium)] outline-none"
                      value={formName}
                ...
                {userRole === 'admin' && (
                  <div className="space-y-1">
                    ...
                    <select
                      ...
                      className="w-full px-4 py-2.5 rounded-xl border border-gray-200 bg-white font-medium text-sm text-[#111111] focus:ring-2 focus:ring-[var(--gold-medium)] outline-none"
                    >
                ...
                <div className="space-y-1">
                  <label className="text-xs font-bold text-gray-500 uppercase tracking-wide">
                    {formRole === 'faculty' ? 'Employee Code / ID' : 'Roll No'}
                  </label>
                  <div className="relative">
                    <input
                      type="text"
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="relative">
                        <input
                          type="text"
                          placeholder="e.g. CSE"
                          className="w-full pl-9 pr-3 py-2 rounded-xl border border-gray-200 text-xs font-medium focus:ring-2 focus:ring-[var(--gold-medium)] outline-none"
                          value={formBranch}
                ...
                <div className="pt-4 flex gap-3 border-t border-gray-100">
                  <button
                    ...
                    className="flex-1 py-3 bg-[var(--gold-gradient)] text-white rounded-xl font-bold text-sm shadow-md hover:opacity-95 transition-all disabled:opacity-50"
                  >
