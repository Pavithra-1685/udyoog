  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8 pb-20">
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-[var(--gold-medium)] bg-white/50"
              />
            </div>
          </div>
          <div className="space-y-1">
            <label className="text-sm font-medium text-gray-700 flex items-center gap-2">Roll No</label>
            <input
              type="text"
              required
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-1">
            ...
            <select
              ...
              className="w-full px-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-[var(--gold-medium)] bg-white/50 appearance-none cursor-pointer"
            >
      ...
      <section className="space-y-4">
        ...
        <div className="bg-[#111111]/5 p-6 rounded-2xl border border-[#111111]/10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div className="space-y-1">
              <label className="text-sm font-bold text-[#111111]">Overall CGPA (Auto-calculated)</label>
              <div className="w-full px-4 py-2.5 rounded-xl border border-gray-300 bg-gray-100 text-[#111111] font-bold text-lg">
                {formData.cgpa || '0.00'}
              </div>
            </div>
          </div>
            ...
            {[1, 2, 3, 4, 5, 6, 7, 8].map(sem => (
              <div key={sem} className="space-y-1">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-lg border border-gray-200 focus:ring-2 focus:ring-[var(--gold-medium)] bg-white text-sm"
                  placeholder="0.00"
                />
              </div>
            ))}
          ...
          <div className="flex flex-wrap gap-2 items-center">
            ...
            {(Array.isArray(formData.preferred_locations) ? formData.preferred_locations : [])
              ...
              <button
                ...
                key={loc}
                onClick={() => handleLocationToggle(loc)}
                className="px-4 py-1.5 rounded-full text-sm font-medium transition-all bg-[#111111] text-white flex items-center gap-1"
              >
            ...
            <div className="flex gap-2">
              <input 
                ...
                className="px-3 py-1.5 text-sm rounded-full border border-gray-300 focus:ring-2 focus:ring-[var(--gold-medium)] bg-white w-32"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-1">
            <label className="text-sm font-medium text-gray-700 flex items-center gap-2">
              ...
              {(formData.graduation === 'B.Tech' || formData.graduation === 'M.Tech') && <span className="text-[var(--gold-medium)] text-xs">*</span>}
            </label>
            <input
              type="url"
          ...
          <div className="space-y-1">
            <label className="text-sm font-medium text-gray-700 flex items-center gap-2">
              <Linkedin className="w-4 h-4" /> LinkedIn <span className="text-[var(--gold-medium)] text-xs">*</span>
            </label>
            <input
              type="url"
              required
        ...
        <div className="bg-gray-50 p-4 rounded-2xl border border-gray-200 space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <input
              ...
              className="px-4 py-2 rounded-xl border border-gray-300 focus:ring-2 focus:ring-[var(--gold-medium)] bg-white"
            />
            <input
              type="text"
            ...
            <textarea
              ...
              rows={2}
              className="md:col-span-2 px-4 py-2 rounded-xl border border-gray-300 focus:ring-2 focus:ring-[var(--gold-medium)] bg-white resize-none"
            />
          </div>
          <button
            type="button"
            onClick={addProject}
            className="px-4 py-2 bg-[#111111] text-white rounded-xl text-sm font-bold flex items-center gap-2 hover:opacity-90"
          >
          ...
          <div className="space-y-3 mt-4">
            {formData.projects.map((project: any, index: number) => (
              <div key={index} className="relative p-4 bg-white border border-gray-200 rounded-xl shadow-sm">
                ...
                <h4 className="font-bold text-[#111111]">{project.name}</h4>
                <p className="text-sm text-gray-600 mt-1">{project.description}</p>
                <div className="flex flex-wrap gap-2 mt-3">
                  {project.tech?.map((t: string) => (
                    <span key={t} className="px-2 py-0.5 bg-gray-50 text-[#111111] text-[10px] font-bold rounded uppercase">
                      {t}
                    </span>
                  ))}
                </div>
      ...
      <section className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-[var(--gold-medium)]"
          >
        ...
        <div className="bg-gray-50 p-4 rounded-2xl border border-gray-200">
          <div className="flex flex-col sm:flex-row gap-2 mb-4">
            ...
            <button
              type="button"
              onClick={addSkill}
              className="px-4 py-2 bg-[#111111] text-white rounded-xl"
            >
      ...
      <div className="fixed bottom-6 left-1/2 -translate-x-1/2 w-full max-w-lg px-4">
        <button
          type="submit"
          disabled={isLoading}
          className="w-full flex items-center justify-center gap-3 py-4 rounded-2xl text-white font-bold text-lg shadow-xl shadow-[var(--gold-medium)]/30 transition-all hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50"
