  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          <div className="p-4 rounded-2xl bg-[var(--gold-gradient)]/10">
            <Target className="w-8 h-8 text-[var(--gold-medium)]" />
          </div>
          <div>
            <p className="text-sm text-gray-500 font-medium">Readiness Score</p>
            <p className="text-3xl font-bold" style={{ color: '#111111' }}>{completionPercent}%</p>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="backdrop-blur-lg bg-white/70 rounded-3xl shadow-lg border border-gray-200/50 p-6 flex items-center gap-4"
        >
          <div className="p-4 rounded-2xl bg-[#111111]/10">
            <Award className="w-8 h-8 text-[#111111]" />
          </div>
          <div>
            <p className="text-sm text-gray-500 font-medium">Expert Skills</p>
            <p className="text-3xl font-bold" style={{ color: '#111111' }}>{skills.filter(s => s.level === 'Expert').length}</p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div>
            ...
            <p className="text-3xl font-bold" style={{ color: '#111111' }}>{profile?.cgpa || '0.0'}</p>
          </div>
        </motion.div>
      </div>
      ...
      >
        <h3 className="text-xl font-bold mb-6 flex items-center gap-2" style={{ color: '#111111' }}>
            ...
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={cgpaData} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
                ...
                <Line 
                  ...
                  strokeWidth={4} 
                  dot={{ r: 6, fill: 'var(--gold-medium)', strokeWidth: 2, stroke: '#fff' }}
                  activeDot={{ r: 8, fill: '#111111', strokeWidth: 0 }}
                />
              </LineChart>
            </ResponsiveContainer>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        >
          <h3 className="text-xl font-bold mb-6 flex items-center gap-2" style={{ color: '#111111' }}>
            <CheckCircle2 className="w-6 h-6 text-[var(--gold-medium)]" />
            Skill Proficiency
          </h3>
          {skills.length > 0 ? (
        ...
        <motion.div
          ...
          className="backdrop-blur-lg bg-white/70 rounded-3xl shadow-lg border border-gray-200/50 p-8"
        >
          <h3 className="text-xl font-bold mb-6" style={{ color: '#111111' }}>Level Distribution</h3>
