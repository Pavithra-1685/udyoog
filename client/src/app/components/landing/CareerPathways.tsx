      ...
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <div className="relative group/scroll px-4 -mx-4">
          ...
          <button
            ...
            className="p-3 bg-gray-50 hover:bg-gray-100 text-black rounded-full hidden md:flex items-center justify-center transition-all duration-300 shadow-sm active:scale-90 cursor-pointer absolute left-2 md:-left-8 lg:-left-12 top-1/2 -translate-y-[calc(50%+16px)] z-20 border border-gray-100/50"
          >
          ...
          <button
            ...
            className="p-3 bg-gray-50 hover:bg-gray-100 text-black rounded-full hidden md:flex items-center justify-center transition-all duration-300 shadow-sm active:scale-90 cursor-pointer absolute right-2 md:-right-8 lg:-right-12 top-1/2 -translate-y-[calc(50%+16px)] z-20 border border-gray-100/50"
          >
          ...
          {pathwaysData.roles.map((role, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-white border border-gray-150 rounded-3xl p-6 sm:p-8 flex flex-col justify-between cursor-pointer shadow-sm hover:shadow-lg hover:-translate-y-1.5 active:scale-[0.98] active:shadow-md active:-translate-y-0.5 transition-all duration-300 origin-center w-[85vw] sm:w-[350px] md:w-[380px] lg:w-[400px] flex-shrink-0 snap-start opacity-100 visible group"
              >
