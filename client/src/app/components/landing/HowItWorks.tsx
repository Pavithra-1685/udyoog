        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          {howItWorksData.steps.map((step, index) => {
            ...
            return (
              <div
                key={index}
                className="reveal-item bg-white border border-gray-150 rounded-3xl p-6 flex flex-col justify-between cursor-pointer origin-center shadow-sm hover:shadow-xl hover:-translate-y-2 hover:border-[#C66E00]/30 active:scale-[0.98] active:shadow-md active:-translate-y-0.5 transition-all duration-300 group"
              >
